...
export const COMMANDS: Command[] = [
  ...
  { id: "c-trash", name: "Move to Trash", group: "File", shortcut: ["Del"], icon: "trash" },
  { id: "c-tag", name: "Add Tag...", group: "File", shortcut: ["Ctrl", "T"], icon: "tag" },
  { id: "c-copy", name: "Copy", group: "File", shortcut: ["Ctrl", "C"], icon: "copy" },
  { id: "c-copy-path", name: "Copy Path", group: "File", shortcut: ["Shift", "Ctrl", "C"], icon: "copy" },
  ...
  { id: "c-open-with", name: "Open with...", group: "Open", shortcut: ["Shift", "Ctrl", "O"], icon: "share" },
...
export const SHORTCUTS: ShortcutGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { keys: ["Del"], desc: "Move to Trash" },
      { keys: ["Ctrl", "C"], desc: "Copy" },
      { keys: ["Shift", "Ctrl", "C"], desc: "Copy full path" },
  ...
  },
  {
    ...
    items: [
      ...
      { keys: ["Shift", "Ctrl", "O"], desc: "Open with..." },
    ],
  },
  {
